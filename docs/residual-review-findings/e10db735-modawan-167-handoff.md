...
**Recorded:** 2026-06-05 (updated 2026-06-11 — LFG pass 27)  
**OpenKotOR `glad-gles`:** `00956ec4`  
**OpenKotOR `master`:** `c49cceac`
...
| CI | OpenKotOR `master` green @ `c49cceac` (post #29 merge); modawan #167 has no required checks |
